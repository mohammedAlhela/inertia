<template>
    <section class="">
        ...
        <form @submit.prevent="create">
            <div class="input-fields-holder">
                <div class="image-file-input">
                    ...
                    <div class="upload-holder">
                        <div class="file-holder">
                            <label for="user_create_image" class="custom-file-upload">
                                <v-icon> mdi-pencil </v-icon>
                            </label>
                            <input accept="image/*" id="user_create_image" type="file"
                ...
                <div class="row">
                    <div class="input-holder col-md-6">
                        ...
                        <span class="validation-error" v-if="form.errors.name">{{ form.errors.name }}</span>
                    </div>
                    ...
                    <div class="input-holder col-md-6">
                        ...
                        <div class="password">
                            <input v-model="form.password" :type="passwordType" type="password" />
                            <span class="validation-error" v-if="form.errors.password">{{ form.errors.password }}</span>
                    ...
                    <div class="input-holder col-md-6">
                        ...
                        <div class="password">
                            <input v-model="form.password_confirmation" :type="passwordConfirmationType"
                                type="password" />
            ...
            <div class="buttons">
                <v-btn color="blue" dark :loading="form.processing" type="submit">Create new user
                </v-btn>

<Link href = "/users">     <v-btn color="blue-grey" class="ma-3 white--text">
    Discard
...
export default {
    ...
    methods: {
        ...
        clearImage() {
            ...
            document.getElementById("user_create_image").value = "";
        },
