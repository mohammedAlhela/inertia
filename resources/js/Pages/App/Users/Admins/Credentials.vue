                ...
                <v-form @submit.prevent="update" ref="form">
                    <v-row class="inputs-holder">
                        ...
                        <v-col cols="12" class="py-2">
                            <v-checkbox label="Change password" v-model="form.updatePassword"
                                color="deep-purple lighten-1" hide-details @click="resetformValidation()" />
                        </v-col>
                        
                        <v-col cols="12" class="py-2" v-if="form.updatePassword">
                            <v-checkbox label="Send email notification" v-model="form.sendUpdateNotification"
                                color="deep-purple lighten-1" hide-details />
                        </v-col>


                        <v-col cols="12" class="py-2">
                            <v-checkbox label="Logout this user from all active sessions"
                        ...
                        <div v-if="form.updatePassword" class = "pt-2">
